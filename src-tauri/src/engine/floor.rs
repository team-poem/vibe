/// Adaptive noise floor estimate based on an exponential moving average of
/// frame RMS levels. Candidate (loud) frames must not be fed into `update`
/// so that claps do not drag the floor upward.
